...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showMap() {
        intent = new Intent(MainActivity.this, WeatherMapsActivity.class);
        startActivity(intent);
    }

    private void showWeatherByAddress() {
        intent = new Intent(MainActivity.this, ChooseAddressActivity.class);
        startActivity(intent);
    }

    private void showCurrentWeather() {
        intent = new Intent(MainActivity.this, WeatherCurrentLocationActivity.class);
        startActivity(intent);
    }
}
